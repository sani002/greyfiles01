...
def setup_model_and_index(_all_docs):  # The leading underscore is added to avoid caching this argument
    ...
    llm = Groq(model="llama3-70b-8192", api_key="YOUR_GROQ_API_KEY")  # Replace with your actual API key
...
st.title("Grey Files Prototype 0.2")
...
if user_question:
    response = combined_query(user_question, index.as_query_engine(), None, st.session_state.chat_history)
